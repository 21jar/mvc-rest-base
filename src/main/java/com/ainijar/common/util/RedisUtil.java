...
public class RedisUtil {
	...
	public List<Object> getRange(final String key) throws Exception {
	...
	public Set<String> getKeySet(final String key) throws Exception {
		Assert.hasText(key, "Key is not empty.");
	...
	public Object lpop(final String key) throws Exception {
		Assert.hasText(key, "Key is not empty.");
	...
	public long decrBy(final String key, final Long by) throws Exception {
		Assert.hasText(key, "Key is not empty.");
	...
	public void delByCodePattern(final String key) throws Exception {
		Assert.hasText(key, "Key is not empty.");
	...
	public void lSet(final String key, final long index, final String setValue) throws Exception {
		Assert.hasText(key, "Key is not empty.");
	...
	public long lRem(final String key, final String value) throws Exception {
		Assert.hasText(key, "Key is not empty.");
